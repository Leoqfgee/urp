...
The app uses a 188-view, 73,047-record ORB database made only from real open
bottle photographs. Robust multi-point PnP recovers B's full 6DoF pose and
...
The Android artifact is `Builds/BottleRepairAR_v34.apk`. Offline and editor
