...
The v31 build retains the 10-level ORB pyramid (1.15 scale factor) and low FAST
...
relocalization. Real-device v30 evidence also showed valid 30/30 and 37/39
PnP consensus being rejected only because the label points occupied a narrow
horizontal band. v31 keeps the strict spatial gate for weak solutions and uses
a count-adaptive gate only for dense, low-error, high-ratio consensus.
