...
namespace Urp.ArDemo.Editor
{
    public static class UrpArProjectSetup
    {
        ...
        private const string AndroidApkPath = "Builds/BottleRepairAR_v61.apk";
